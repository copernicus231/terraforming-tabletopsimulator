...
function venusClick(obj,player_clicker_color,alt_click)
    venusTrackButton:doClick(obj,player_clicker_color,alt_click)
end

function earthClick(obj,player_clicker_color,alt_click)
    earthTrackButton:doClick(obj,player_clicker_color,alt_click)
end
function marsClick(obj,player_clicker_color,alt_click)
    marsTrackButton:doClick(obj,player_clicker_color,alt_click)
end
function jovianClick(obj,player_clicker_color,alt_click)
    jovianTrackButton:doClick(obj,player_clicker_color,alt_click)
end
venusTrackButton={button ={ index = 0,
 ...
 function placeGeneric(obj,color)
 ...
 function placeGenericClick(obj,player_clicker_color,alt_click)
     genericTileButton:doClick(obj,player_clicker_color,alt_click)
 end
